...
class OpenWorkbookOperation(BaseModel):
    """Operation to open an Excel or CSV file."""

    filepath: Annotated[str, Field(description="Path to the Excel (.xlsx, .xlsm) or CSV (.csv) file")]
